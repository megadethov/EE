...
//    private List<String> listOperations = new ArrayList<>(); // поле класса не потокобезопасно
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Создаем Map для хранения сессий, пытаемся получить ее из getServletContext()
        // Key = session id, Value = List операций калькулятора
        ...
        PrintWriter out = response.getWriter();
            ...
            try {
                ...
                // установка атрибута с областью видимости Context
                request.getServletContext().setAttribute("obj", new TestObject("Test name"));
